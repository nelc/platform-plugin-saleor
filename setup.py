#!/usr/bin/env python
"""
Package metadata for platform_plugin_saleor.
"""
import os
import re
import sys
...
VERSION = get_version('platform_plugin_saleor', '__init__.py')
...
setup(
    ...
    url='https://github.com/nelc/platform-plugin-saleor',
    packages=find_packages(
        include=['platform_plugin_saleor', 'platform_plugin_saleor.*'],
        exclude=["*tests"],
    ),
