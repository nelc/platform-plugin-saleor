...
"""
platform-plugin-saleor documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-saleor',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/nelc/platform-plugin-saleor",
...
#
# html_title = 'platform-plugin-saleor v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_saleor'),
                os.path.join(root_path, 'platform_plugin_saleor/migrations')])
